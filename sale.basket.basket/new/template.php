        ...
        <div class="row">
            ...
            <div class="mb-3 basket-items-list-wrapper basket-items-list-wrapper-height-fixed basket-items-list-wrapper-light<?=$displayModeClass?>"
                ...
                <div class="basket-items-list-header" data-entity="basket-items-list-header">
                    <div class="basket-items-list-header-filter" style="margin-bottom: 7px">
                        <span class="bskt-cnt font-weight-bold mb-md-4" data-filter="all" style="color: #0b011d"></span>
                    </div>
                </div>
            ...
            )
            {
                ?>
                    ...
                    <div class="col-md-6 col-lg-5 col-xl-4" data-entity="basket-total-block"></div>
