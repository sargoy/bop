					...
					<tr id="<?= $arItem['ID'] ?>">
						...
						if ($bDelayColumn || $bDeleteColumn) { ?>
							<td class="control">
								...
								if ($bDeleteColumn) { ?>
									<a class="delete-item fa fa-times"
		...
		<div class="bx_ordercart_order_pay">
				...
				<div class="col-xs-12 col-sm-6 bx_ordercart_coupon_column" id="coupons_block">
                    <?php if ($arParams['HIDE_COUPON'] != 'Y') { ?>
                        <div class="intec-ordercart_coupon">
                            ...
                            <input type="text" class="intec-ordercart-input" id="coupon" name="COUPON" value="" onchange="enterCoupon();">
                        </div>
			...
			<div class="bx_ordercart_order_pay_center row">
				...
				<div class="col-xs-12 col-sm-4 sale_back_wrapper">
					<a class="intec-ordercart-button intec-ordercart-button-transparent sale_back"
					   href="<?= $saleBack ?>"
                    ><?= GetMessage('SALE_BACK') ?></a>
				</div>
				<div class="col-xs-12 col-sm-8">
					<a class="intec-ordercart-button intec-ordercart-button-colored sale_order"
