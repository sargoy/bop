...
if (isset($arResult['ITEM'])):
	...
	?>
    <div class="card card-product" id="<?=$arResult['AREA_ID'];?>">
            ...
            <div class="embed-responsive embed-responsive-4by3">
                <div class="embed-responsive-item d-flex">
                    <a href="<?=$arItem['DETAIL_PAGE_URL']?>" target="_self" class="item-title">
                        <img data-src="<?=$file['src']?>" src="/images/spinner.gif" class="card-img lazy" alt="<?=$arItem["NAME"]?>">
                    </a>
        ...
        <div class="card-body">
            <a href="<?=$arItem['DETAIL_PAGE_URL']?>" target="_blank" class="item-title"><?=$arItem['NAME'];?></a>
            <div class="item-price">
                ...
                <p class="price">
                    ...
                    <?else:?>
                        <span><?=$arOffer['PRICES']['BASE']['PRINT_VALUE'];?></span>
	                <?endif;?>
                </p>
            </div>
        </div>
        <div class="card-footer swiper-no-swiping">
            ...
            <?if($arParams['~FAV_STYLE'] == 'Y'):?>
                <button type="button" class="btn btn-icon btn-fav ml-2 btn-link element-fav-remove active" data-element-id="<?=$arItem['ID']?>">
                    <svg width="22" height="20" xmlns="http://www.w3.org/2000/svg" class="icon sprite-icons">
