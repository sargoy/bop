...
if($arResult['VARIABLES']['REVIEWS'] != 'Y') {
...
$elementId = $APPLICATION->IncludeComponent(
    ...
    array(
        ...
        'SECTION_ID' => $GLOBALS['VARIABLES']['SECTION_ID'],
...
if($arResult['VARIABLES']['REVIEWS'] != 'Y') {
    ...
    //      'PROPERTY_LINK' => (!empty($recommendedData['IBLOCK_LINK']) ? $recommendedData['IBLOCK_LINK'] : $recommendedData['ALL_LINK']),
            ...
            'PROPERTY_CODE_'.$arParams['IBLOCK_ID'] => (isset($arParams['LIST_OFFERS_PROPERTY_CODE']) ? $arParams['LIST_OFFERS_PROPERTY_CODE'] : []),
            'CART_PROPERTIES_'.$arParams['IBLOCK_ID'] => (isset($arParams['PRODUCT_PROPERTIES']) ? $arParams['PRODUCT_PROPERTIES'] : []),
            'CART_PROPERTIES_'.$arParams['IBLOCK_ID'] => (isset($arParams['OFFERS_CART_PROPERTIES']) ? $arParams['OFFERS_CART_PROPERTIES'] : []),
            'OFFER_TREE_PROPS_'.$arParams['IBLOCK_ID'] => (isset($arParams['OFFER_TREE_PROPS']) ? $arParams['OFFER_TREE_PROPS'] : []),
            'ADDITIONAL_PICT_PROP_'.$arParams['IBLOCK_ID'] => $arParams['ADD_PICT_PROP'],
            'ADDITIONAL_PICT_PROP_'.$arParams['IBLOCK_ID'] => $arParams['OFFER_ADD_PICT_PROP'],
            'CONVERT_CURRENCY' => $arParams['CONVERT_CURRENCY'],
            'CURRENCY_ID' => $arParams['CURRENCY_ID'],
            ...
            'ZLOJ_CURRENT_ELEMENT' => $GLOBALS['zloj_session']['CURRENT_ELEMENT']['ID'],
            'SHOW_ADULT' => \Zloj\Portal\Functions::getAdult(),
        ),
        $component
    );
}else{
    $APPLICATION->AddChainItem('Отзывы', $GLOBALS['zloj_session']['CURRENT_ELEMENT']['CANONICAL_PAGE_URL'].'reviews/');
    $GLOBALS['zloj_session']['prev_item'] = $GLOBALS['zloj_session']['CURRENT_ELEMENT']['CANONICAL_PAGE_URL'];
    $APPLICATION->SetPageProperty("canonical", $GLOBALS['zloj_session']['CURRENT_ELEMENT']['CANONICAL_PAGE_URL'].'reviews/');
}
