...
$this->addExternalJs($templateFolder.'/order_ajax.js_old');
\Bitrix\Sale\PropertyValueCollection::initJs();
$this->addExternalJs($templateFolder.'/script.js_old');
?>
	<NOSCRIPT>
...
else
{
	...
	?>
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data" class="order-form">
		<?
		...
		<input type="hidden" name="BUYER_STORE" id="BUYER_STORE" value="<?=$arResult['BUYER_STORE']?>">
                <input type="hidden" name="SITE_ID" id="SITE_ID" value="<?=CUtil::JSEscape($component->getSiteId())?>">
                <input type="hidden" name="LANG_CHARSET" id="LANG_CHARSET" value="<?=LANG_CHARSET?>">
                
		<div id="bx-soa-order" class="row bx-soa-smart bx-<?=$arParams['TEMPLATE_THEME']?>">
			<!--	MAIN BLOCK	-->
			<div class="col-sm-9 bx-soa">
				...
				<? if ($arParams['BASKET_POSITION'] === 'before'): ?>
					<!--	BASKET ITEMS BLOCK	-->
					<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-soa-basket bx-active">
						<div class="bx-soa-section-title-container">
				...
				<!--	REGION BLOCK	-->
				<div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-soa-region bx-active">
					<div class="bx-soa-section-title-container">
						<h2 class="bx-soa-section-title">
				...
				<? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
					<!--	PAY SYSTEMS BLOCK	-->
					<div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-soa-paysystem bx-active">
						<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title">
					...
					<!--	DELIVERY BLOCK	-->
					<div id="bx-soa-delivery" data-visited="false" class="bx-soa-section bx-soa-delivery bx-active" <?=($hideDelivery ? 'style="display:none"' : '')?>>
						<div class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title">
				...
				<? endif ?>
				<!--	BUYER PROPS BLOCK	-->
				<div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-soa-properties bx-active">
					<div class="bx-soa-section-title-container">
						<h2 class="bx-soa-section-title">
				...
				<!--	ORDER SAVE BLOCK	-->
				<div id="bx-soa-orderSave" class="bx-soa-orderSave">
					<div class="checkbox">
						<?
			...
			<div id="bx-soa-total" class="col-sm-3 bx-soa-sidebar">
				...
				<div class="name"><?=GetMessage('SIDE_BASKET_NAME')?></div>
	...
	if ($arParams['SHOW_PICKUP_MAP'] === 'Y' || $arParams['SHOW_MAP_IN_PROPS'] === 'Y')
	{
		...
		{
			$this->addExternalJs($templateFolder.'/scripts/yandex_maps.js_old');
			?>
		...
		{
			$this->addExternalJs($templateFolder.'/scripts/google_maps.js_old');
